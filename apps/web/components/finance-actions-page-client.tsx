...
type FinanceActionsPageClientProps = {
  schoolId: string;
  userId: string;
...
export function FinanceActionsPageClient({
  schoolId,
  userId,
  academicYearId,
  gradingPeriodId,
}: FinanceActionsPageClientProps) {
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setInvoiceForm((prev) => ({ ...prev, studentId: e.target.value }))
                }
              />
            </div>
